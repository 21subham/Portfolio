...
const FOOTER_CONTACT = "subhamrajbhandari@gmail.com | +977 9818813360";
...
export default function Footer() {
  const socialLinks = [
    ...
    },
    {
      name: "instagram",
      icon: FaInstagram,
      href: "https://www.instagram.com/subham_rb/",
    ...
    },
    {
      name: "linkedin",
      icon: FaLinkedin,
      href: "https://www.linkedin.com/in/subham-rajbhandari-4808a6236/",
    ...
    <footer className="flex flex-col lg:flex-row justify-between items-center lg:items-start py-8 px-4 lg:px-16 relative inset-x-0 bottom-0 bg-background">
      ...
      <div className="hidden lg:block lg:w-1/3 text-left self-center">
        ...
        <p className="text-gray-500 mt-2">
          I appreciate your interest in my work. Stay connected with me on
